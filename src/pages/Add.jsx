...
import { addVideos } from '../service/allapi';
...
function Add({handleresponse}) { 
  ...
  // set input function definition s
  ...
  const handleAdd = async () => {
    ...
    if (!id || !caption || !thumbnail || !url) {
      ...
      let response = await addVideos(uploadData)
  ...
  // https://www.youtube.com/watch?v=nYEoxne_20Y ....youtubeurl


  // https://www.filmibeat.com/img/2023/09/rdxbo-1695098545.jpg
